 ...
 * 
 * We have followed general OpenZeppelin Contracts guidelines: functions revert instead
 * returning `false` on failure. This behavior is nonetheless conventional and does not
 * conflict with the expectations ofns ERC20 applications.
 *
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    /** @dev Creates `amount` tokens and assigns them to `account`, increasing total supply.
